...
/**
 * Třída, která slouží k načítání OspfModelu z externích souborů. Načítání může
 * probíhat dle nastavení z místního adresáře, nebo z webu.
 * 
 * @author Jakub Menzel
...
public class OspfLoader {
	...
	/**
	 * Metoda, která načte ze zadaného umístění jména routerů a náležitě upraví
	 * model
	 * 
	 * @throws IOException
	 */
	 ...
	 * @throws Exception
	 */
	public static void loadRouterGeoPositions(OspfModel model, BufferedReader input)
	...
	public static void getTopologyFromCiscoData(OspfModel model, BufferedReader input)
			throws NumberFormatException, IOException {
		try {
	...
	public static void getTopologyFromRuggedComData(OspfModel model, BufferedReader input)
			throws NumberFormatException, IOException {
		try {
			//TODO: Implement me
			// zapis dat do souboru
